...
import { searchArticles } from "./positionedArticle.js";
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        let newArticles = yield searchArticles(keyword, articlePerPage, 0);
        renderNewArticles(newArticles);
        doc.get("searched-text").innerText = keyword;
        doc.addClick(loadDiv, showMore);
    });
}
function renderNewArticles(articleData) {
...
function showMore() {
    return __awaiter(this, void 0, void 0, function* () {
        let newArticles = yield searchArticles(keyword, articlePerPage, articles.length);
        renderNewArticles(newArticles);
    });
}
